...
$factory->define(Userflights::class, function (Faker $faker) {
    return [
        'serialnumber'  => $faker->bothify('********************'),
        'latitude'      => $faker->latitude(-90, 90),
        'longitude'     => $faker->longitude(-180, 180),
        'fligthpath' => $faker->randomElement(
            [
                                "{[
                        'coordinates': [
                        [
        ...
        'height'        => $faker->unique()->randomNumber($nbDigits = 4),
        'temperature'   => $faker->unique()->randomNumber($nbDigits = 2),
        'weather'       => $faker->randomElement(
            [
                "Sunny",
                "Rainy",
                "Cloudy",
